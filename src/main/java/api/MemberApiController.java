...
public class MemberApiController {
    ...
    public CreateMemberResponse saveMemberV2(@RequestBody @Valid
        ...
        // 여기서 set 해서 이름을 변경하는게 API 에 영향을 주지 않는다는것!
    ...
    public UpdateMemberResponse updateMemberV2(@PathVariable("id") Long id,
        ...
        // 다시 찾아오는 이유 ! update 는 변경을 하는 친구인데 ! 얘에서 뭔가를 반환해오는게 로직상 이상하다 !
        // 그래서 귀찮더라도 아래에서 다시 가져온다 !
...
//조회 V1: 안 좋은 버전, 모든 엔티티가 노출, @JsonIgnore -> 이건 정말 최악, api가 이거 하나 인가! 화면에 종속적이지 마라!
    ...
    public Result membersV2() {
        ...
        // 이런식으로 한번 감싸서 보내줘야 한다 ! ? 왜? 바로 가면 제이슨 배열타입으로 나가버리기에 ! 유연성 떨어진다 !
